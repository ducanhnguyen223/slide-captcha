import { DEVTOOLS_CONNECTION_META_FILENAME, DEVTOOLS_MOUNT_PATH, DEVTOOLS_RPC_DUMP_MANIFEST_FILENAME, REMOTE_CONNECTION_KEY } from "./constants.js";
...
function extractKeyFromFragment(hash) {
	...
	for (const part of raw.split("&")) {
		...
		if (k === "vite-devtools-kit-connection") return decodeURIComponent(v);
	}
	return null;
}
