...
import { defineComponent, createElementBlock, shallowRef, getCurrentInstance, provide, cloneVNode, h, computed, toValue, onServerPrefetch, ref, nextTick, unref, toRef, reactive, watch, withAsyncContext, mergeProps, withCtx, createTextVNode, useSSRContext } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate } from "vue/server-renderer";
import { hash } from "/Users/m/Documents/Project/Captcha/node_modules/ohash/dist/index.mjs";
...
import { debounce } from "/Users/m/Documents/Project/Captcha/node_modules/perfect-debounce/dist/index.mjs";
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(pending)) {
        ...
        _push(`<div class="stats" data-v-6c5cb050><div class="stat-card" data-v-6c5cb050><h3 data-v-6c5cb050>Total Challenges</h3><p class="stat-value" data-v-6c5cb050>${ssrInterpolate(unref(stats)?.totalChallenges || 0)}</p></div><div class="stat-card" data-v-6c5cb050><h3 data-v-6c5cb050>Total Solves</h3><p class="stat-value" data-v-6c5cb050>${ssrInterpolate(unref(stats)?.totalSolves || 0)}</p></div><div class="stat-card" data-v-6c5cb050><h3 data-v-6c5cb050>Success Rate</h3><p class="stat-value" data-v-6c5cb050>${ssrInterpolate(((unref(stats)?.successRate || 0) * 100).toFixed(1))}%</p></div><div class="stat-card" data-v-6c5cb050><h3 data-v-6c5cb050>Avg Solve Time</h3><p class="stat-value" data-v-6c5cb050>${ssrInterpolate(((unref(stats)?.avgSolveTime || 0) / 1e3).toFixed(1))}s</p></div></div>`);
      }
      _push(`</main></div>`);
    };
  }
...
//# sourceMappingURL=dashboard-Dbk1uvxH.js.map
